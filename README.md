...
DESCRIPTION
       ...
       3 years as a Senior Test Technician at TrueNAS, where I extended a
       22,000-line Bash automation suite for manufacturing QC — batch BIOS
       configuration and hardware validation over IPMI and Redfish across
       16+ server platforms — and maintained the CI/CD pipeline publishing
       TrueNAS ISOs into the iPXE boot menu.

       Now designing and operating a self-hosted homelab using
       Infrastructure as Code — provisioning, hardening, and observing
       every layer.

       RHCSA in progress. Fluent in English and Spanish.

SKILLS
       Languages       Bash (primary), Python, HCL

       Systems         Linux (Ubuntu, RHEL, Debian, Rocky, TrueNAS/FreeBSD),
                       UNIX, TCP/IP, VLAN, LAGG, RAID, ZFS, PXE/iPXE Boot

       Hardware        IPMI, Redfish API, BMC, BIOS & firmware, SAS/HBA,
                       SMART
